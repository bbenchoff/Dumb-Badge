...
void drawChar(uint8_t character)
{
	...
	uint8_t stupidletter[200] = {
		...
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,	//9
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,	//10
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x00,	//11
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x00,	//12
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,	//13
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,	//14
		0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,	//15
		0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,	//16
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, //17
		0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,	//18
	...
	*/
	...
	int x = 0;
	int y = 0;
	for(int i=0; i < (sizeof(stupidletter)/sizeof(stupidletter[0])); i++)
	{
		if(stupidletter[i] != 0)
		{
			setColorRGB(128,128,0);
		...
		y=i/10;
		x=i%10;
		//printf("%i, \t%i, \t%i, \t%i \r",i, stupidletter[i],x,y);
	}
}
